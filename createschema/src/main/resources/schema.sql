...
CREATE TABLE IF NOT EXISTS authorities (
  ...
  create table statuses( id bigserial not null, code varchar(255), name varchar(255), primary key(id));
  create table brands (id  bigserial not null, description varchar(255), logo varchar(255), name varchar(255), code varchar(255), primary key (id));
  ...
  create table orders (id  bigserial not null, delivery_address varchar(255), delivery_method_id int8, payment_method_id int8, user_id int8, primary key (id));
  ...
  create table status_history (id  bigserial not null, date_from timestamp, date_to timestamp, address varchar(255), order_id int8, primary key (id));
  create table typeprice (id  bigserial not null, name varchar(255), primary key (id));
  create table users (id  bigserial not null, enabled boolean, username varchar(255), fio varchar(255), password varchar(255), phone varchar(255), role varchar(255), address varchar(255), primary key (id));
  create table warehouses (id  bigserial not null, contacts varchar(255), name varchar(255), schedule varchar(255), address varchar(255), primary key (id));
